...
\begin{frame}
    ...
    \begin{block}{Proof \formalduck}
        \begin{flalign*}
            \onslide<6->{\E(W_t^2 - t \mid \cF_s) & = }
            \onslide<7->{ \E((W_s + (W_t - W_s))^2  \mid \cF_s) - t& =}
            \onslide<8->{ \E(W_s^2 + (W_t - W_s)^2 + 2W_s(W_t-W_s) \mid \cF_s) - t =\\}
            \onslide<9->{ W_s^2 + \E((W_t - W_s)^2 \mid \cF_s) + 2W_s \E(W_t-W_s \mid \cF_s) -t & =\\}
            \onslide<10->{ W_s^2 + \E((W_t - W_s)^2) + 2W_s \E(W_t-W_s) -t & =\\}
            \onslide<11->{ W_s^2 + (t-s) + 2W_s \cdot 0 - t& = W_s^2  - s}
        \end{flalign*}
